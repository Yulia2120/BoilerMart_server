...
export class ShoppingCartService {
    ...
    async add(addToCartDto: AddToCartDto){
        ...
        cart.name = part.name;
        cart.total_price = part.price; //по дефолту цена одного товара

        return cart.save();
    }

    //метод возвращает количество выбранного товара
    ...
    //метод возвращает общую сумму товаров
    ...
    //удаляем все товары заказанные данным пользователем
